...
const tusb_desc_device_t ps4_compat_desc_device = {
    .bLength = sizeof(tusb_desc_device_t),
    .bDescriptorType = TUSB_DESC_DEVICE,
    .bcdUSB = 0x0200,
    .bDeviceClass = TUSB_CLASS_UNSPECIFIED,
    ...
    .bDeviceProtocol = 0x00,
    .bMaxPacketSize0 = CFG_TUD_ENDPOINT0_SIZE,
    .idVendor = 0x1532,  // Razer
    .idProduct = 0x0401, // Panthera
    .bcdDevice = 0x0100,
    .iManufacturer = USBD_STR_MANUFACTURER,
    .iProduct = USBD_STR_PRODUCT,
    .iSerialNumber = USBD_STR_SERIAL,
...
const usbd_driver_t hid_ps4_compat_device_driver = {
    .name = "PS4 Compat",
    .app_driver = &hid_app_driver,
    .desc_device = &ps4_compat_desc_device,
    .desc_cfg = ps4_desc_cfg,
    .desc_bos = NULL,
    .send_report = send_hid_ps4_report,
};